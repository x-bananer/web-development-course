...
const getDistance = (user, coords) => {
	const [userLat, userLng] = user
...
navigator.geolocation.getCurrentPosition((pos) => {
  ...
  restaurants.sort((a, b) => {
    const distA = getDistance(userLocation, a.location.coordinates);
    const distB = getDistance(userLocation, b.location.coordinates);
